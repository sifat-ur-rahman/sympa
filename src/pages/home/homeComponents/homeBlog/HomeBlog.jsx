...
function HomeBlog() {
  ...
  return (
    <div className="bg-slate-50  relative">
        ...
        <div className="pt-10"> 
        <section data-aos="fade-down"  className=" mx-80 flex items-center justify-between py-14">
            <div>
        ...
        <section className="grid grid-cols-3 gap-6 items-center mx-80   pb-20">
            <div data-aos="fade-up-right" className="bg-white relative border  hover:border-orange-400">
                <img src={blog01} alt="" />
                <p className="absolute left-2 top-56 bg-orange-500 text-white p-3 rounded-lg font-semibold">30 May 2023</p>
